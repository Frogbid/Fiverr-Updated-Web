<div class="side-content-wrap">
    <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
        <ul class="navigation-left">
            <li class="nav-item" data-item="dashboard"><a class="nav-item-hold" href="#"><i class="nav-icon i-Bar-Chart"></i><span class="nav-text">Home</span></a>
                <div class="triangle"></div>
            </li>
            <li class="nav-item" data-item="uikits"><a class="nav-item-hold" href="#"><i class="nav-icon i-Library"></i><span class="nav-text">Request a Consultation</span></a>
                <div class="triangle"></div>
            </li>
            <li class="nav-item" data-item="extrakits"><a class="nav-item-hold" href="#"><i class="nav-icon i-Suitcase"></i><span class="nav-text">Services</span></a>
                <div class="triangle"></div>
            </li>
            <li class="nav-item" data-item="apps"><a class="nav-item-hold" href="#"><i class="nav-icon i-Computer-Secure"></i><span class="nav-text">Cars For Sale</span></a>
                <div class="triangle"></div>
            </li>
            <li class="nav-item" data-item="widgets"><a class="nav-item-hold" href="#"><i class="nav-icon i-Computer-Secure"></i><span class="nav-text">Referral Program</span></a>
                <div class="triangle"></div>
            </li>
            <li class="nav-item" data-item="charts"><a class="nav-item-hold" href="#"><i class="nav-icon i-File-Clipboard-File--Text"></i><span class="nav-text">About Us</span></a>
                <div class="triangle"></div>
            </li>
            <li class="nav-item" data-item="forms"><a class="nav-item-hold" href="#"><i class="nav-icon i-File-Clipboard-File--Text"></i><span class="nav-text">Contact Us</span></a>
                <div class="triangle"></div>
            </li>
...
<!--        <li class="nav-item"><a href="dashboard3.html"><i class="nav-icon i-Over-Time"></i><span class="item-name">Version 3</span></a></li>
        ...
        <ul class="childNav" data-parent="extrakits">
            <li class="nav-item"><a href="services.php"><i class="nav-icon i-Crop-2"></i><span class="item-name">Services Page</span></a></li>
        ...
        <ul class="childNav" data-parent="uikits">
            <li class="nav-item"><a href="consultation.php"><i class="nav-icon i-Bell1"></i><span class="item-name">Consultation Page</span></a></li>
            <li class="nav-item"><a href="consultation_form.php"><i class="nav-icon i-Split-Horizontal-2-Window"></i><span class="item-name">Consultation Form Data</span></a></li>
